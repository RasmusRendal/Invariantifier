...
class Options:
    ...
    def parse_args(self, xtest_len):
        ...
        parser.add_argument('--examples', dest='examples', type=int, default=20,
                            nargs='?', help='How many training examples to refer to')
        parser.add_argument('--step', dest='step', type=int,
                            default=20, nargs='?', help='The step in the rotation')
        parser.add_argument('--layers', dest='layers', type=int,
                            default=0, nargs='?', help='How many convolutional layers to use')
        ...
        parser.add_argument('--sum', dest='use_sum', action='store_true',
        ...
        if args.samples > xtest_len:
            ...
            print("Automatically reduced the amount of samples to " + str(xtest_len))
